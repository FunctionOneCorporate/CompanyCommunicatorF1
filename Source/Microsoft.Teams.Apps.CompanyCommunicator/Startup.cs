...
namespace Microsoft.Teams.Apps.CompanyCommunicator
{
    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddOptions<ImgRepository>()
                .Configure<IConfiguration>((repositoryOptions, configuration) =>
                {
                    repositoryOptions.StorageAccountConnectionString =
                        configuration.GetValue<string>("StorageAccountConnectionString");
            ...
            services.AddOptions<DraftNotificationPreviewOptions>()
                .Configure<IConfiguration>((draftNotificationPreviewOptions, configuration) =>
                {
                    draftNotificationPreviewOptions.UrlApiLog = configuration.GetValue<string>("WebApiLogUser");
                });
            ...
            // Tramento de imagem.
            services.AddSingleton<IImagem, Imagem>();
            ...
            services.AddSingleton<ReactionMessageDataRepository>();
            ...
            services.AddSingleton<TeamsRatingAnalyticsDataRepository>();
