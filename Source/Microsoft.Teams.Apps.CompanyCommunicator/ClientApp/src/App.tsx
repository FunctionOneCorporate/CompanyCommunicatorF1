...
import NewMessageSchedule from './components/NewMessage/scheduleNewMessage';
import NewMessageTemplate from './components/NewMessage/templateNewMessage';
          ...
          <div className="appContainer">
            <BrowserRouter>
              <Switch>
                ...
                <Route exact path="/newmessageschedule/:id" component={NewMessageSchedule} />
                <Route exact path="/newmessagetemplate/:id" component={NewMessageTemplate} />
