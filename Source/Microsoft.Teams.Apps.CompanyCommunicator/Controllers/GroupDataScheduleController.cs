// <copyright file="GroupDataScheduleController.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Controllers
{
    ...
    /// </summary>
    [Route("api/groupdataschedule")]
    [Authorize(PolicyNames.MustBeValidUpnPolicy)]
    public class GroupDataScheduleController : Controller
    {
        private readonly NotificationDataRepository notificationDataRepository;
        private readonly IGroupsService groupsService;

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupDataScheduleController"/> class.
        /// </summary>
        ...
        public GroupDataScheduleController(
