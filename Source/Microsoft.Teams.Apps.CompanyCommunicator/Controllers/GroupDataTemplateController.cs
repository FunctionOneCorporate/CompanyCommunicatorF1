// <copyright file="GroupDataTemplateController.cs" company="Microsoft">
...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Controllers
{
    ...
    /// </summary>
    [Route("api/groupdatatemplate")]
    [Authorize(PolicyNames.MustBeValidUpnPolicy)]
    public class GroupDataTemplateController : Controller
    {
        private readonly NotificationDataRepository notificationDataRepository;
        private readonly IGroupsService groupsService;

        /// <summary>
        /// Initializes a new instance of the <see cref="GroupDataTemplateController"/> class.
        /// </summary>
        ...
        public GroupDataTemplateController(
