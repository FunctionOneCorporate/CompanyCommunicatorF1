...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Controllers
{
    ...
    public class SentNotificationsController : ControllerBase
    {
        ...
        /// <param name="teamsRatingAnalyticsDataRepository"> The class for manipulation data rating. </param>
            ...
            [FromBody] DraftNotification draftNotification)
        {
            ...
            var strNmMessage = draftNotificationDataEntity.NmMensagem;
            ...
            // Insert data in Table TeamsRatingAnalitics
