...
namespace Microsoft.Teams.Apps.CompanyCommunicator.Common.Repositories.NotificationData
{
    ...
    public static class NotificationDataTableNames
    {
        ...
        /// <summary>
        /// Schedule notification partition key name.
        /// </summary>
        public static readonly string ScheduleNotificationsPartition = "ScheduleNotifications";

        /// <summary>
        /// Template notification partition key name.
        /// </summary>
        public static readonly string TemplateNotoficationsPartition = "TemplateNotifications";
    }
}
